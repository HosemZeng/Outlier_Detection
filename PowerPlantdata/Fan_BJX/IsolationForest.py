...
y_test = pd.read_csv('./groudtruth_Fan_BJX.csv',header=None).values.T[0]
...
#计算指标
clf = IsolationForest(n_estimators=800,contamination=0.001,max_features=9,max_samples='auto')#预先得到的最佳
