...
y_test = pd.read_csv('./groudtruth_NJSB.csv',header=None).values.T[0]
...
#计算指标
clf = IsolationForest(n_estimators=800,contamination=0.001,max_features=9,max_samples=20000)#自动参数搜索+人工调试得到的最佳参数
